...
public final class AppConstants {
    ...
    private static final String DEV_FILE_PATH = RESOURCE_PATH + "/dev.properties";
    private static final String QA_FILE_PATH = RESOURCE_PATH + "/qa.properties";
    private static final String TESTDATA_FILE_PATH = RESOURCE_PATH + "/testdata.xlsx";
    private static final String REPORTS_FOLDER_PATH = System.getProperty("user.dir") + "/reports-test-output";
    private static final String JSON_TEST_DATA_PATH = RESOURCE_PATH + "/testdata.json";
    private static final int GLOBAL_WAIT = 10;

    public static String getDevFilePath(){ return DEV_FILE_PATH; }

    public static String getQAFilePath(){ return QA_FILE_PATH; }
